...
<nav class="navbar navbar-dark bg-dark navbar-expand-lg">
	...
	<div class="collapse navbar-collapse" id="navbarText">
    	<ul class="navbar-nav mr-auto">
      		...
      		<li class="nav-item active"><a class="nav-link" href="RemoveUser">Remove User</a></li>
    	</ul>
	</div>
...
<div class="main fadein">
	<h4>Remove Users</h4><br>
	<div>
		<form class="p-3" action="RemoveUser" method="POST">
			...
			<button style="float: right" class="btn btn-primary active" type="submit">Remove Users</button>
			<br><br>
